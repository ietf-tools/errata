...
# NOTE WELL: Testing in development mode. If any runtime guards are added for production mode,
...
# Suppress log output during tests. assertLogs / assertNoLogs install their own
# handlers on demand and are unaffected by this configuration.
LOGGING = {
    "version": 1,
