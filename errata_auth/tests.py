...
# based on github.com/ietf-tools/purple/rpcauth/tests.py
...
from .backends import ErrataOIDCAuthBackend


class ErrataOIDCAuthBackendTests(TestCase):
    ...
    def test_verify_token(self, token_mock):
        ...
        token_mock.return_value = {
            ...
            "exp": int(
                # now + 10 minutes
                datetime.datetime.now(datetime.UTC).timestamp() + 600
            ),
            "sub": "test-subject-id",
        }
